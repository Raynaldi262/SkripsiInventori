                            ...
                            <div class="card">
                                ...
                                <div class=" card-body">
                                    <table id="dataAdmin" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php $i = 1;
                                            while ($data = mysqli_fetch_assoc($jenis_barang)) { ?>
                                                <tr>
                                                    <td><?php echo $i ?></td>
                                                    ...
                                                    <td>
                                                            ...
                                                            <form action="../model/AdminBarang.php" method="post">
                                                                ...
                                                                <button type="submit" name="deleteJenis" class="btn btn-danger"><i class="fas fa-times"></i></button>
                                                            </form>
                                                    </td>
                                                </tr>
                                            <?php $i++;
                ...
                <div class="modal-body" style="text-align: center;">
                    <form action="../model/AdminBarang.php" method="post">
                        ...
                        <div class="input-group mb-3">
                            <div class="col-5 input-group-text">Jenis Barang </div>
                            <input type="text" class="form-control" placeholder="Jenis Barang" name="jb">
                            <div class="input-group-append">
                            </div>
                        </div>

                        <input type="submit" class="btn btn-success" name="insert_jenis" value="Tambah Data">
                    </form>
                </div>
            </div>
            <!-- /.modal-content -->
            ...
            <div class="modal-content col-8">
                ...
                <div class="modal-body" style="text-align: center;">
                    <form action="../model/AdminBarang.php" method="post">
                        ...
                        <div class="input-group mb-3">
                            <div class="col-5 input-group-text">Jenis Barang : </div>
                            <input type="text" class="form-control" placeholder="jenis barang" name="edt_jenis" id="edt_jenis">
                            <div class="input-group-append">
                            </div>
                        </div>
                        <input type="submit" class="btn btn-success" name="save_jenis" value="Edit Data">
                    </form>
                </div>
            </div>
            <!-- /.modal-content -->

                            ...
                            <div class="card">
                                ...
                                <div class=" card-body">
                                    <table id="dataAdmin" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php $i = 1;
                                            while ($data = mysqli_fetch_assoc($masuk)) { ?>
                                                <tr>
                                                    <td><?php echo $i ?></td>
                                                    ...
                                                    <td>
                                                            <form action="../model/AdminBarang.php" method="post">
                                                                ...
                                                                <button type="submit" name="deleteMasuk" class="btn btn-danger"><i class="fas fa-times"></i></button>
                                                            </form>
                                                    </td>
                                                </tr>
                                            <?php $i++;
                ...
                <div class="modal-body" style="text-align: center;">
                    <form action="../model/AdminBarang.php" method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Kode Supplier" name="trx" value="<?php echo getFormatMasuk() ?>" readonly>
                            <div class="input-group-append">
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            <div class="col-5 input-group-text">Tanggal Masuk </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select id="supplier" name="supplier" required >
                                ...
                                <option value="<?= $row['nama_supplier']; ?>">
                                    <?= $row['nama_supplier']; ?>
                                </option>
                            <?php } ?>
                            </select>
                        ...
                        <input type="submit" class="btn btn-success" name="insert_masuk" value="Tambah Data">
                    </form>
                </div>
            </div>
            <!-- /.modal-content -->
